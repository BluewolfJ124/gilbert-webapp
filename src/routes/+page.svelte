<script>
    ...
    let imgClass = "inline-block flex-none w-[480px] h-[324px] bg-gradient-to-tr from-primary-500 to-secondary-800 rounded-lg transition-all duration-200 justify-center items-center p-1";
    let container;
    function syncScroll() {
...
<div class="-mx[10vw]">
  <div class="relative isolate px-6 pt-14 lg:px-8" >
    ...
    <div class="mx-auto py-80 sm:py-60 lg:py-80" >
        ...
        <p class="text-lightParagraph dark:text-paragraph animate-slidein500 opacity-0">Hi, I'm Jamie, and this is my website about Gilbert. I build backend and frontend apps and run a Minecraft server.</p>
