...
<p class="text-lightParagraph dark:text-paragraph my-10">Gilbert the Beanie Boo is a cute pink giraffe with purple spots. She is super soft to cuddle! Her birthday is August 23rd and she loves to eat icecream. Gilbert lives on my bed and she is very cute. Sometimes she visits my sisters bed to sleep. 💖✨ Here are some pictures of Gilbert:</p>
...
<hr class="my-12 h-0.5 border-t-0 bg-neutral-200 dark:bg-white/10" />
<h2 class="heading-primary">Projects I Am Working On</h2>
<hr class="my-12 h-0.5 border-t-0 bg-neutral-200 dark:bg-white/10" />
