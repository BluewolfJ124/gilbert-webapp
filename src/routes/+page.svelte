<script>
    ...
    let imgClass = "inline-block flex-none sm:w-[240px] sm:h-[162px] lg:w-[480px] lg:h-[324px] bg-gradient-to-tr from-primary-500 to-secondary-800 rounded-lg transition-all duration-200 justify-center items-center p-1";
    let container;
    function syncScroll() {
      if (typeof window !== 'undefined') {
        container.scrollLeft = window.scrollY-600;
      }
    }
    ...
    let count = $state(0);
    onMount(async () => {
      const response = await fetch('https://counter.bluewolfj124.workers.dev/read');
      if (!response.ok) {
    ...
    try {
      const response = await fetch('https://counter.bluewolfj124.workers.dev/increment'); 
      if (!response.ok) {
...
<div class="-mx[10vw]">
  <div class="relative isolate px-6 pt-14 lg:px-8" >
    <div class="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
      <div class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-primary-400 to-secondary-800 opacity-40 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div>
    <div class="mx-auto py-90 sm:py-60 lg:py-80" >
        <Heading tag="h1" class="mb-4 animate-slidein300  opacity-0" customSize="text-6xl font-extrabold  md:text-5xl lg:text-8xl">Welcome to my Website</Heading>
        <p class="text-lightParagraph dark:text-paragraph animate-slidein500 opacity-0">Hi, I'm Jamie, and this is my website about Gilbert. I play video games, build backend and frontend apps, and run a Minecraft server.</p>
        <div class="mt-10 flex items-center gap-x-6 animate-slidein700  opacity-0">
          <Button size='xl' class='btn bg-pink-500'>Join the Server</Button>
          <a href="/about" class="text-xl font-semibold text-Lightparagraph dark:text-paragraph">Learn more about me<span aria-hidden="true">→</span></a>
        </div>
    </div>
    <div class="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[calc(100%-50rem)]" aria-hidden="true">
      <div class="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-primary-400 to-secondary-800 opacity-40 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div>
  </div>
</div>
<br>
...
<p class="text-lightParagraph dark:text-paragraph my-10">Gilbert the Beanie Boo is a cute pink giraffe with purple spots. She is super soft to cuddle! 🐆🌈 Her birthday is August 23rd, loves to eat icecream. 💖✨ Here are some pictures of Gilbert:</p>
...
<h2 class="heading-primary"> Where is Gilbert? </h2>
    <p class="text-lightParagraph dark:text-paragraph">Gilbert lives on my bed and she is very cute. Sometimes she visits my sisters bed to sleep sometimes. </p>
